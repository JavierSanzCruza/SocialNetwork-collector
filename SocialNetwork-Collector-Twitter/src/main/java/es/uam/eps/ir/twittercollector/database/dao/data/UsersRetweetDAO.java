 ...
 */
public interface UsersRetweetDAO 
{
   ...
   // public User find(String email, String password) throws DAOException;
    ...
    /**
     * Returns a list of UsersRetweet given a retweeter identificator
     * @param retweeter Retweeter id
     * @return The list of usersRetweet
     */
     ...
     * @param creator The original creator of the tweet
     * @param retweeter The retweeter of the tweet
     ...
     * @throws DAOException If something fails at database level.
     */
    public void update(UsersRetweet user) throws IllegalArgumentException, DAOException;
