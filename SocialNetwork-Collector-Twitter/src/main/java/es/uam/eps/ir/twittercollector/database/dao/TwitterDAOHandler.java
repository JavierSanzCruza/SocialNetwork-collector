 ...
 * @author Javier
 */
public class TwitterDAOHandler 
{
    /**
     * Set of DAOFactory identified by the database name.
     */
    private HashMap<String, TwitterDAOFactory> factories;
    /**
     * Instance of the handler.
     */
    private static TwitterDAOHandler instance = null;
     ...
     */
    public static TwitterDAOHandler getInstance()
    {
        if(instance == null)
        {
            instance = new TwitterDAOHandler();
        }
        return instance;
    }
   
    private TwitterDAOHandler()
    {
    ...
    public boolean addFactory(String database)
    {
        ...
        this.factories.put(database, TwitterDAOFactory.getInstance(database));   
        return true;
    }
     ...
     */
    public TwitterDAOFactory getFactory(String database)
    {
    ...
    public void close()
    {
        for(TwitterDAOFactory fact : this.factories.values())
        {
            try 
            {
                fact.close();
            ...
            {
                Logger.getLogger(TwitterDAOHandler.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
