...
import es.uam.eps.ir.twittercollector.grid.Parameters;
 ...
 */
public class TweetCollectorParamReader extends ParametersReader
{
    /**
     ...
     */
    public void readCollector(Element node)
    {
     ...
     */
    public String printTweetCollector() 
    {
        String expiration = "";
