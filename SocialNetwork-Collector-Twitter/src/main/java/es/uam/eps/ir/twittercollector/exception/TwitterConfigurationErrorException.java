 ...
 */
public class TwitterConfigurationErrorException extends TwitterCollectorException 
{
    // Constants ----------------------------------------------------------------------------------
     ...
     */
    public TwitterConfigurationErrorException(String message) {
        super(message);
    }
     ...
     */
    public TwitterConfigurationErrorException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause The root cause of the TwitterConfigurationErrorException.
     */
    public TwitterConfigurationErrorException(String message, Throwable cause) {
        super(message, cause);
    }
}
