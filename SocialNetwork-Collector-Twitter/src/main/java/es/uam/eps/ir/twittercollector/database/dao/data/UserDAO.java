...
public interface UserDAO 
{
   ...
   // public User find(String email, String password) throws DAOException;
     ...
     * @param friend Followed User
     */
    public void addFollowRelation(User follower, User friend);

    /**
     * Adds a retweet relation between users to the database. If it exists, adds 1 to the column
     * frequency
     * @param original User that originally posted the tweet
     * @param retweeter User that retweeted the tweet
     */
    public void addOrUpdateRetweetRelation(User original, User retweeter);
    
    
    /**
     * Sets the user as visited, and its level in the exploration tree.
     * @param user visited user.
     * @param level level of the tree.
     */
    public void setVisited(User user, Integer level);
    
    public List<Long> getFollowing(Long followerId);
    public HashMap<Long, User> hashMap();
