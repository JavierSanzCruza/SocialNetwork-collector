...
import es.uam.eps.ir.twittercollector.stopcondition.NumVisitedStopCondition;
 ...
 */
public class NumVisitedStopConditionConfigurator implements StopConditionConfigurator
{
    /**
    ...
    public StopCondition configure(StopConditionParamReader params) 
    {
        ...
        return new NumVisitedStopCondition(count);
    }
