...
public class Parameters 
{
     ...
     */
    public Parameters(Map<String, Double> doubleValues, Map<String, String> stringValues, Map<String, Integer> integerValues, Map<String, Boolean> booleanValues, Map<String, Long> longValues)
    {
