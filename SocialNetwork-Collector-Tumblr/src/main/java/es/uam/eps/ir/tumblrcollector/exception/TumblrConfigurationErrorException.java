 ...
 */
public class TumblrConfigurationErrorException extends TumblrCollectorException 
{
    // Constants ----------------------------------------------------------------------------------
     ...
     */
    public TumblrConfigurationErrorException(String message) {
        super(message);
    }
     ...
     */
    public TumblrConfigurationErrorException(Throwable cause) {
        super(cause);
    }
     ...
     * @param cause The root cause of the TwitterConfigurationErrorException.
     */
    public TumblrConfigurationErrorException(String message, Throwable cause) {
        super(message, cause);
    }
}
